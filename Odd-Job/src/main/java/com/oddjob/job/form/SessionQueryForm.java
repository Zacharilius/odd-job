...
import com.oddjob.job.form.ConferenceQueryForm.Field;
import com.oddjob.job.form.ConferenceQueryForm.FieldType;
import com.oddjob.job.form.ConferenceQueryForm.Filter;
import com.oddjob.job.form.ConferenceQueryForm.Operator;

public class SessionQueryForm {
	 private static final Logger LOG = Logger.getLogger(SessionQueryForm.class.getName());
	    ...
	    public static enum Field {
	        ...
	        TYPE_OF_SESSION("typeOfSession", FieldType.STRING);
